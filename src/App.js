...
<div className='holder'>
    ...
    <Row xs={1} md={4} className="g-4">
        ...
        <Col className="mb-0 p-4">
          <Card style={{ width: '18rem' }} border="secondary">
            <Card.Img variant="top" src={imagen.img[32]} style={{ width: '17.9rem', height:'10rem' }}/>
            <Card.Body>
              <Card.Title>{todos[32].Nombre}</Card.Title>
              <Card.Text>
              {todos[32].Ubicacion}
              </Card.Text>
              <Button variant="outline-secondary">+ Información</Button>
        ...
        <Col className="mb-0 p-4">
          <Card style={{ width: '18rem' }} border="secondary">
            <Card.Img variant="top" src={imagen.img[33]} style={{ width: '17.9rem', height:'10rem' }}/>
            <Card.Body>
              <Card.Title>{todos[33].Nombre}</Card.Title>
              <Card.Text>
              {todos[33].Ubicacion}
              </Card.Text>
              <Button variant="outline-secondary">+ Información</Button>
        ...
        <Col className="mb-0 p-4">
          <Card style={{ width: '18rem' }} border="secondary">
            <Card.Img variant="top" src={imagen.img[34]} style={{ width: '17.9rem', height:'10rem' }}/>
            <Card.Body>
              <Card.Title>{todos[34].Nombre}</Card.Title>
              <Card.Text>
              {todos[34].Ubicacion}
              </Card.Text>
              <Button variant="outline-secondary">+ Información</Button>
        ...
        <Col className="mb-0 p-4">
          <Card style={{ width: '18rem' }} border="secondary">
            <Card.Img variant="top" src={imagen.img[35]} style={{ width: '17.9rem', height:'10rem' }}/>
            <Card.Body>
              <Card.Title>{todos[35].Nombre}</Card.Title>
              <Card.Text>
              {todos[35].Ubicacion}
              </Card.Text>
              <Button variant="outline-secondary">+ Información</Button>
        ...
        <Col className="mb-0 p-4">
          <Card style={{ width: '18rem' }} border="secondary">
            <Card.Img variant="top" src={imagen.img[36]} style={{ width: '17.9rem', height:'10rem' }}/>
            <Card.Body>
              <Card.Title>{todos[36].Nombre}</Card.Title>
              <Card.Text>
              {todos[36].Ubicacion}
              </Card.Text>
              <Button variant="outline-secondary">+ Información</Button>
        ...
        <Col className="mb-0 p-4">
          <Card style={{ width: '18rem' }} border="secondary">
            <Card.Img variant="top" src={imagen.img[37]} style={{ width: '17.9rem', height:'10rem' }}/>
            <Card.Body>
              <Card.Title>{todos[37].Nombre}</Card.Title>
              <Card.Text>
              {todos[37].Ubicacion}
              </Card.Text>
              <Button variant="outline-secondary">+ Información</Button>
        ...
        <Col className="mb-0 p-4">
          <Card style={{ width: '18rem' }} border="secondary">
            <Card.Img variant="top" src={imagen.img[38]} style={{ width: '17.9rem', height:'10rem' }}/>
            <Card.Body>
              <Card.Title>{todos[38].Nombre}</Card.Title>
              <Card.Text>
              {todos[38].Ubicacion}
              </Card.Text>
              <Button variant="outline-secondary">+ Información</Button>
        ...
        <Col className="mb-0 p-4">
          <Card style={{ width: '18rem' }} border="secondary">
            <Card.Img variant="top" src={imagen.img[39]} style={{ width: '17.9rem', height:'10rem' }}/>
            <Card.Body>
              <Card.Title>{todos[39].Nombre}</Card.Title>
              <Card.Text>
              {todos[39].Ubicacion}
              </Card.Text>
              <Button variant="outline-secondary">+ Información</Button>
        ...
        <Col className="mb-0 p-4">
          <Card style={{ width: '18rem' }} border="secondary">
            <Card.Img variant="top" src={imagen.img[40]} style={{ width: '17.9rem', height:'10rem' }}/>
            <Card.Body>
              <Card.Title>{todos[40].Nombre}</Card.Title>
              <Card.Text>
              {todos[40].Ubicacion}
              </Card.Text>
              <Button variant="outline-secondary">+ Información</Button>
        ...
        <Col className="mb-0 p-4">
          <Card style={{ width: '18rem' }} border="secondary">
            <Card.Img variant="top" src={imagen.img[41]} style={{ width: '17.9rem', height:'10rem' }}/>
            <Card.Body>
              <Card.Title>{todos[41].Nombre}</Card.Title>
              <Card.Text>
              {todos[41].Ubicacion}
              </Card.Text>
              <Button variant="outline-secondary">+ Información</Button>
        ...
        <Col className="mb-0 p-4">
          <Card style={{ width: '18rem' }} border="secondary">
            <Card.Img variant="top" src={imagen.img[42]} style={{ width: '17.9rem', height:'10rem' }}/>
            <Card.Body>
              <Card.Title>{todos[42].Nombre}</Card.Title>
              <Card.Text>
              {todos[42].Ubicacion}
              </Card.Text>
              <Button variant="outline-secondary">+ Información</Button>
        ...
        <Col className="mb-0 p-4">
          <Card style={{ width: '18rem' }} border="secondary">
            <Card.Img variant="top" src={imagen.img[43]} style={{ width: '17.9rem', height:'10rem' }}/>
            <Card.Body>
              <Card.Title>{todos[43].Nombre}</Card.Title>
              <Card.Text>
              {todos[43].Ubicacion}
              </Card.Text>
              <Button variant="outline-secondary">+ Información</Button>
        ...
        <Col className="mb-0 p-4">
          <Card style={{ width: '18rem' }} border="secondary">
            <Card.Img variant="top" src={imagen.img[44]} style={{ width: '17.9rem', height:'10rem' }}/>
            <Card.Body>
              <Card.Title>{todos[44].Nombre}</Card.Title>
              <Card.Text>
              {todos[44].Ubicacion}
              </Card.Text>
              <Button variant="outline-secondary">+ Información</Button>
        ...
        <Col className="mb-0 p-4">
          <Card style={{ width: '18rem' }} border="secondary">
            <Card.Img variant="top" src={imagen.img[45]} style={{ width: '17.9rem', height:'10rem' }}/>
            <Card.Body>
              <Card.Title>{todos[45].Nombre}</Card.Title>
              <Card.Text>
              {todos[45].Ubicacion}
              </Card.Text>
              <Button variant="outline-secondary">+ Información</Button>
        ...
        <Col className="mb-0 p-4">
          <Card style={{ width: '18rem' }} border="secondary">
            <Card.Img variant="top" src={imagen.img[46]} style={{ width: '17.9rem', height:'10rem' }}/>
            <Card.Body>
              <Card.Title>{todos[46].Nombre}</Card.Title>
              <Card.Text>
              {todos[46].Ubicacion}
              </Card.Text>
              <Button variant="outline-secondary">+ Información</Button>
        ...
        <Col className="mb-0 p-4">
          <Card style={{ width: '18rem' }} border="secondary">
            <Card.Img variant="top" src={imagen.img[47]} style={{ width: '17.9rem', height:'10rem' }}/>
            <Card.Body>
              <Card.Title>{todos[47].Nombre}</Card.Title>
              <Card.Text>
              {todos[47].Ubicacion}
              </Card.Text>
              <Button variant="outline-secondary">+ Información</Button>
        ...
        <Col className="mb-0 p-4">
          <Card style={{ width: '18rem' }} border="secondary">
            <Card.Img variant="top" src={imagen.img[48]} style={{ width: '17.9rem', height:'10rem' }}/>
            <Card.Body>
              <Card.Title>{todos[48].Nombre}</Card.Title>
              <Card.Text>
              {todos[48].Ubicacion}
              </Card.Text>
              <Button variant="outline-secondary">+ Información</Button>
        ...
        <Col className="mb-0 p-4">
          <Card style={{ width: '18rem' }} border="secondary">
            <Card.Img variant="top" src={imagen.img[49]} style={{ width: '17.9rem', height:'10rem' }}/>
            <Card.Body>
              <Card.Title>{todos[49].Nombre}</Card.Title>
              <Card.Text>
              {todos[49].Ubicacion}
              </Card.Text>
              <Button variant="outline-secondary">+ Información</Button>
